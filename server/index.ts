  ...
  app.use(helmet({
    ...
    contentSecurityPolicy: {
      directives: {
        ...
        scriptSrc: ["'self'", "https://www.googletagmanager.com", "https://netsync.yellowpages.ca"],
        workerSrc: ["'self'"],
        manifestSrc: ["'self'"],
        connectSrc: ["'self'", "https://www.google-analytics.com", "https://analytics.google.com", "https://region1.google-analytics.com", "https://netsync.yellowpages.ca"],
        frameSrc: ["'self'", "https://netsync.yellowpages.ca"],
        objectSrc: ["'none'"],
        baseUri: ["'self'"],
        formAction: ["'self'"],
        frameAncestors: ["'self'"],
