...
export default function Home() {
  ...
  return (
    <div className="min-h-screen bg-background text-foreground">
      ...
      <section id="contact" className="bg-gradient-to-b from-background to-white py-20">
        <div className="container">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-12">
            {/* Contact Info */}
            <div>
              <p className="text-sm uppercase tracking-[0.4em] text-primary font-bold mb-4">Get Started</p>
              <h2 className="text-4xl md:text-5xl font-bold text-secondary mb-8" style={{ fontFamily: 'Montserrat' }}>
                Get in Touch
              </h2>
              ...
              <div className="space-y-6">
                ...
                <div className="flex gap-4">
                  ...
                  <div>
                    ...
                    <a href="tel:+148383471823" className="text-lg text-primary hover:underline font-bold">
                      +1 (483) 834-7182
                    </a>
                  </div>
                </div>
                ...
                <div className="flex gap-4">
                  ...
                  <div>
                    ...
                    <a href="https://wa.me/233242011305" className="text-lg text-primary hover:underline font-bold">
                      +233 24 201 1305
                    </a>
                  </div>
                </div>
                ...
                <div className="flex gap-4">
                  ...
                  <div>
                    ...
                    <div className="space-y-1">
                      <div>
                        <a href="mailto:info.fixmydoor@gmail.com" className="text-lg text-primary hover:underline font-bold">
                          info.fixmydoor@gmail.com
                        </a>
                      </div>
                      <div>
                        <a href="mailto:ampofor55@gmail.com" className="text-lg text-primary hover:underline font-bold">
                          ampofor55@gmail.com
                        </a>
                      </div>
                    </div>
                ...
                <div className="flex gap-4">
                  ...
                  <div>
                    <p className="font-semibold text-secondary mb-2">Follow Us</p>
                    <div className="flex gap-4">
            ...
            <div className="bg-white rounded-2xl p-8 shadow-xl border-2 border-primary">
              <h3 className="text-2xl font-bold text-secondary mb-6" style={{ fontFamily: 'Montserrat' }}>Book a Repair</h3>
              <Form {...form}>
                <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-5">
                  ...
                  <FormField
                    ...
                    render={({ field }) => (
                      <FormItem>
                        <FormLabel className="text-foreground font-bold">Name *</FormLabel>
                        <FormControl>
                          <Input placeholder="Your full name" {...field} className="border-2 border-gray-300 focus:border-primary" />
                        </FormControl>
                        <FormMessage />
                      </FormItem>
                    )}
                  ...
                  <FormField
                    ...
                    render={({ field }) => (
                      <FormItem>
                        <FormLabel className="text-foreground font-bold">Phone *</FormLabel>
                        <FormControl>
                          <Input type="tel" placeholder="+1 (438) 000-0000" {...field} className="border-2 border-gray-300 focus:border-primary" />
                        </FormControl>
                        <FormMessage />
                      </FormItem>
                    )}
                  ...
                  <FormField
                    ...
                    render={({ field }) => (
                      <FormItem>
                        ...
                        <FormControl>
                          <Input type="email" placeholder="your.email@example.com" {...field} className="border-2 border-gray-300 focus:border-primary" />
                        </FormControl>
                        <FormMessage />
                      </FormItem>
                    )}
                  ...
                  <FormField
                    ...
                    render={({ field }) => (
                      <FormItem>
                        <FormLabel className="text-foreground font-bold">Address *</FormLabel>
                        <FormControl>
                          <Input placeholder="Your full address in Montreal" {...field} className="border-2 border-gray-300 focus:border-primary" />
                        </FormControl>
                        <FormMessage />
                      </FormItem>
                    )}
                  ...
                  <FormField
                    ...
                    render={({ field }) => (
                      <FormItem>
                        <FormLabel className="text-foreground font-bold">Service Type *</FormLabel>
                  ...
                  <FormField
                    ...
                    render={({ field }) => (
                      <FormItem>
                        <FormLabel className="text-foreground font-bold">Preferred Date</FormLabel>
                        <FormControl>
                          <Input type="date" {...field} className="border-2 border-gray-300 focus:border-primary" />
                        </FormControl>
                        <FormMessage />
                      </FormItem>
                    )}
                  ...
                  <FormField
                    ...
                    render={({ field }) => (
                      <FormItem>
                        <FormLabel className="text-foreground font-bold">Message</FormLabel>
                        <FormControl>
                          <Textarea
                            placeholder="Describe your repair needs in detail..."
                            className="min-h-24 border-2 border-gray-300 focus:border-primary"
                            {...field}
                          />
                        </FormControl>
                        <FormMessage />
                  ...
                  {/* Submit Button */}
                  <Button type="submit" className="w-full bg-primary hover:bg-primary/90 text-white font-bold py-3 rounded-lg transform transition hover:scale-105" disabled={form.formState.isSubmitting}>
